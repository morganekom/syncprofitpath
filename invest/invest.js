...
async function loadPlans() {
    ...
    if (error) {
        ...
        grid.innerHTML = '<p style="color:var(--color-danger); padding:1rem 0;">Failed to load plans. Please refresh the page.</p>';
        return;
    }

    if (!plans || plans.length === 0) {
        grid.innerHTML = '<p style="color:var(--color-gray-light); padding:1rem 0;">No investment plans available at the moment.</p>';
        return;
    }
