...
// ── Admin Supabase client — bypasses RLS so writes succeed.
//    Replace the placeholder with your actual service_role key:
//    Supabase → Project Settings → API → service_role (secret)
//    This file is only loaded on admin pages, so it is safe here.
...
const dbAdmin = supabase.createClient(SUPABASE_URL, SUPABASE_SERVICE_KEY, {
    auth: { autoRefreshToken: false, persistSession: false, detectSessionFromUrl: false }
});
