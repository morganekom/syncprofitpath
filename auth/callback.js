    ...
    try {
        ...
        const { data: newUser, error: insertError } = await db
            ...
            .insert([{
                ...
                referral_code:    '',
                // Store Google avatar URL if your users table has a photo_url column
                // photo_url: avatar,
            }])
            .select()
            .single();
        ...
        if (insertError) {
            ...
            showError('Account created with Google but profile setup failed. Please contact support.');
            return;
        }
